...
import { statesData } from "../app/nigeriaGeoJson2";

export default function NigerianMapContent() {
  ...
  return (
    <div className="relative z-10 flex flex-col justify-center sm:py-32 py-10">
